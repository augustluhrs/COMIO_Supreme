...
public class OSC_TD_Receiver : MonoBehaviour
{
    ...
    public float startingXpos = 0;
    public float startingZpos = 0;
    ...
    {
        root.transform.localPosition = new Vector3((_x * floorScale) + startingXpos, root.transform.localPosition.y, root.transform.localPosition.z);
        // Debug.Log(root.transform.localPosition);
    }

    public void setTransformY(float _y)
    {
        // root.transform.localPosition = new Vector3(root.transform.localPosition.x, (_y * floorScale) + startingHeight, root.transform.localPosition.z);
    ...
    {
        root.transform.localPosition = new Vector3(root.transform.localPosition.x, root.transform.localPosition.y, (_z * floorScale) + startingZpos);
    }
}
